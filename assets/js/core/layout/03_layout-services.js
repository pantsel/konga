      ...
      function factory(_) {
        ...
        var generic = {
          ...
          'frontend': {
            'Frontend <span class="text-muted">generic</span>': [
              {
                url: repository + 'js/src/app/core/services/ListConfigService.js',
                title: 'ListConfigService.js',
                info: types.frontend.listConfig
              },
              {
                url: repository + 'js/src/app/core/models/factory.js',
                title: 'factory.js',
                info: types.frontend.modelFactory
              },
              {
                url: repository + 'js/src/app/core/services/DataService.js',
                title: 'DataService.js',
                info: types.frontend.dataService
              },
              {
                url: repository + 'js/src/app/core/constants/BackendConfig.js',
                title: 'BackendConfig.js',
                info: types.frontend.backendConfig
              },
              {
                url: repository + 'js/src/app/core/interceptors/AuthInterceptor.js',
                title: 'AuthInterceptor.js',
                info: types.frontend.authInterceptor
              },
              {
                url: repository + 'js/src/app/core/interceptors/ErrorInterceptor.js',
        ...
        var data = {
          'examples.books': {
            ...
            'Frontend': [
              {
                url: repository + 'js/src/app/examples/book/book.js',
                title: 'book.js',
                info: types.frontend.module
              },
              {
                url: repository + 'js/src/app/examples/book/book-controllers.js',
                title: 'book-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'js/src/app/examples/book/book-models.js',
                title: 'book-models.js',
                info: types.generic.model
              },
              {
                url: repository + 'js/src/app/examples/book/list.html',
                title: 'list.html',
          ...
          'examples.authors': {
            ...
            'Frontend': [
              {
                url: repository + 'js/src/app/examples/author/author.js',
                title: 'author.js',
                info: types.frontend.module
              },
              {
                url: repository + 'js/src/app/examples/author/author-controllers.js',
                title: 'author-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'js/src/app/examples/author/author-models.js',
                title: 'author-models.js',
                info: types.generic.model
              },
              {
                url: repository + 'js/src/app/examples/author/list.html',
                title: 'list.html',
                info: types.generic.template
              }
            ]
          ...
          'examples.messages': {
            'Frontend': [
              {
                url: repository + 'js/src/app/examples/messages/messages.js',
                title: 'messages.js',
                info: types.frontend.module
              },
              {
                url: repository + 'js/src/app/examples/messages/messages-controllers.js',
                title: 'messages-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'js/src/app/examples/messages/messages.html',
                title: 'messages.html',
                info: types.generic.template
              }
            ],
            'Frontend <span class="text-muted">generic</span>': [
              ...
              {
                url: repository + 'js/src/app/core/services/MessageService.js',
                title: 'MessageService.js',
                info: 'Service to show messages to users via <em>toastr</em> service.'
              },
              {
                url: repository + 'js/src/app/core/services/HttpStatusService.js',
          ...
          'examples.chat': {
            ...
            'Frontend': [
              {
                url: repository + 'js/src/app/examples/chat/chat.js',
                title: 'chat.js',
                info: types.frontend.module
              },
              {
                url: repository + 'js/src/app/examples/chat/chat-controllers.js',
                title: 'chat-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'js/src/app/examples/chat/chat-directives.js',
                title: 'chat-directives.js',
                info: types.frontend.directive
              },
              {
                url: repository + 'js/src/app/examples/chat/chat-models.js',
                title: 'chat-models.js',
                info: types.generic.model
              },
              {
                url: repository + 'js/src/app/examples/chat/chat.html',
                title: 'chat.html',
                info: types.generic.template
              }
            ]
